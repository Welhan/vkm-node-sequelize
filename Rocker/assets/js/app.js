$(function () {
  ...
  new PerfectScrollbar(".app-container"),
    ...
    $(".dark-mode").on("click", function () {
      if ($(".dark-mode-icon i").attr("class") == "fa-solid fa-sm fa-sun") {
        $(".dark-mode-icon i").attr("class", "fa-solid fa-sm fa-moon");
        $("html").attr("class", "light-theme");
        localStorage.setItem("darkMode", false);
      } else {
        $(".dark-mode-icon i").attr("class", "fa-solid fa-sm fa-sun");
